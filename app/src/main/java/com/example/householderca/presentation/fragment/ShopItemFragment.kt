package com.example.householderca.presentation.fragment
...
import com.example.householderca.databinding.FragmentShopItemBinding
...
class ShopItemFragment : Fragment() {
    ...
    private fun observeViewModel() {
        viewModel.availableClose.observe(viewLifecycleOwner) {
